...
const Index = () => {
  ...
  const getImages = () => {
    return selectedCategory === "Wellness" ? [
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <Dialog open={isGalleryOpen} onOpenChange={setIsGalleryOpen}>
          <DialogContent className={lightboxIndex !== null ? "max-w-4xl w-[95vw] bg-transparent border-none shadow-none p-0 group" : "max-w-6xl w-[95vw] h-[80vh] sm:h-[75vh] overflow-hidden"}>
            <DialogHeader className={lightboxIndex !== null ? "sr-only" : ""}>
              <DialogTitle>{lightboxIndex !== null ? "Image Preview" : "Pictures Gallery"}</DialogTitle>
            </DialogHeader>
            ...
            {lightboxIndex !== null ? (
              <div className="relative w-full flex items-center justify-center">
                <Button
                  ...
                  size="icon"
                  onClick={handlePrev}
                  className="absolute left-2 z-10 text-white bg-black/30 hover:bg-black/50 rounded-full h-12 w-12 opacity-0 group-hover:opacity-100 transition-opacity"
                >
                ...
                <Button
                  ...
                  size="icon"
                  onClick={handleNext}
                  className="absolute right-2 z-10 text-white bg-black/30 hover:bg-black/50 rounded-full h-12 w-12 opacity-0 group-hover:opacity-100 transition-opacity"
                >
                ...
                <Button
                  ...
                  className="absolute top-2 right-2 z-10 text-white bg-black/30 hover:bg-black/50 rounded-full h-10 w-10 opacity-0 group-hover:opacity-100 transition-opacity"
                >
                  <X className="h-6 w-6" />
                </Button>
              </div>
