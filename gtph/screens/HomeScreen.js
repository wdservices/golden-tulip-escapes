...
import { LogOut, MapPin, Building2, Calendar, User, QrCode, Menu, MessageSquare } from 'lucide-react-native';
      ...
      <ScrollView>
        ...
        <View style={styles.actionsGrid}>
          {[
            ...
            { icon: MessageSquare, label: 'Feedback', color: '#f59e0b', action: () => navigation.navigate('Feedback') },
